...
function SessionRow({
  ...
  return (
    <li className="group relative">
      <div
        className={cn(
          '-mr-2 flex min-w-0 items-start gap-1.5 rounded-card py-1.5 pl-2 pr-1 font-sans text-[12.5px] leading-[1.35] text-charcoal hover:bg-ivory',
      ...
      >
        ...
        <button
          ...
          className="ml-auto shrink-0 rounded p-1 text-stone opacity-0 transition hover:bg-sand hover:text-charcoal group-hover:opacity-100"
